...
#' @param save.model (Optional) A Boolean specifying whether or not the fitted model generated by \code{\link[brms]{brm}} should be saved to the unstructured metadata of \code{sc.obj}. Defaults to FALSE. 
#' @details 
#' \itemize{
